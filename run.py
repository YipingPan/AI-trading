...
if __name__ == '__main__':
  ...
  for e in range(args.episode):
    ...
    for time in range(env.n_step):
      ...
      state = next_state
      if done:
        print("Training episode: {}/{}, episode end portfolio: {}, gain: {}".format(
          e + 1, args.episode, info['cur_val'], info['cur_val']-args.initial_invest))
    ...
    if args.mode == 'test' and (e+1) % 100 == 0:
      with open('portfolio_val/{}-{}-{}-greedy.p'.format(timestamp, args.mode, e), 'wb') as fp:
